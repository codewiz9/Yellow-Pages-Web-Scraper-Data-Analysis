import scrapy
from yp_scraper.items import RestruantInfo


class RestruantSpiderSpider(scrapy.Spider):
    name = "restruant_spider"
    ...
    def parse(self, response):
        ...
        while numer_of_pages > 0:
            url = f'https://www.yellowpages.com/{area}-{state}/restaurants?page={page_numebr}'
            page_numebr += 1
            numer_of_pages -= 1
