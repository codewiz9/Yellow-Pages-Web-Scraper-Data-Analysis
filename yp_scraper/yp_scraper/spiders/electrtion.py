import scrapy
from yp_scraper.items import ElctrtionInfo


class ElectrtionSpider(scrapy.Spider):
    name = "electrtion"
    ...
    def parse(self, response):
        ...
        while numer_of_pages > 0:
            url = f'https://www.yellowpages.com/{area}-{state}/electricians?page={page_numebr}'
            page_numebr += 1
            numer_of_pages -= 1
